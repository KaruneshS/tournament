...
def reportMatch(winner, loser):
    ...
    c.execute("INSERT INTO Matches (player,opponent,result) VALUES (%s,%s,true)",(winner,loser))
    c.execute("INSERT INTO Matches (player,opponent,result) VALUES (%s,%s,false)",(loser,winner))
